...
<div class="min-h-screen py-8">
    <div class="container mx-auto px-4" style="max-width: 800px;">
        ...
        <p class="mt-4 text-sm text-gray-500 text-center"><a href="<?php echo BASE_URL; ?>/customer/dashboard.php" class="text-black font-bold uppercase hover:underline">← Back to Dashboard</a></p>
    </div>
</div>
<script>
