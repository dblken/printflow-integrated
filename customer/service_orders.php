...
<div class="min-h-screen py-8">
    <div class="container mx-auto px-4" style="max-width: 900px;">
        ...
        <div class="card overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        <?php if (empty($orders)): ?>
                        <tr><td colspan="5" class="py-8 text-center text-gray-500">No service orders yet. <a href="<?php echo BASE_URL; ?>/customer/dashboard.php" class="text-indigo-600">Browse services</a> to place an order.</td></tr>
                        <?php else: ?>
        ...
        <p class="mt-4"><a href="<?php echo BASE_URL; ?>/customer/dashboard.php" class="text-indigo-600 hover:underline">← Back to Dashboard</a></p>
    </div>
</div>
