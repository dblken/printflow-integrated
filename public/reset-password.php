...
<div class="auth-card">
    ...
    <form id="resetForm" onsubmit="handleReset(event)">
        ...
        <div class="form-group">
            ...
            <div class="input-wrapper">
                <input type="password" name="confirm_password" id="confirm_password" class="form-input" placeholder="Repeat new password" required minlength="8">
...
async function handleReset(e) {
    ...
    if (pass !== confirm) {
        alert.innerHTML = '<div class="alert alert-error">Passwords do not match. Please ensure both fields are identical.</div>';
        return;
    }
    ...
    try {
        ...
        if (result.success) {
            ...
            setTimeout(() => {
                // Redirect to homepage with login modal open
