...
// Use relative login action when on public index so session cookie is sent with POST
$auth_login_action = ($is_public && (basename($script_name) === 'index.php')) ? 'login.php' : ($base_url . '/public/login.php');
$auth_register_action = ($is_public && (basename($script_name) === 'index.php')) ? 'register.php' : ($base_url . '/public/register.php');
?>
<!DOCTYPE html>
