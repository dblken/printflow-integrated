...
<aside class="sidebar">
    <div class="sidebar-header">
        <a href="<?php echo $is_pending ? 'profile.php' : 'dashboard.php'; ?>" class="logo">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo BASE_URL; ?>/staff/profile.php" class="nav-item active">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo BASE_URL; ?>/staff/pos.php" class="nav-item <?php echo $nav_current_file === 'pos.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z"/>
                </svg>
                Point of Sale (POS)
            </a>
            <a href="<?php echo BASE_URL; ?>/staff/job_orders_management.php" class="nav-item <?php echo $nav_current_file === 'job_orders_management.php' ? 'active' : ''; ?>">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="nav-section">
            ...
            <a href="<?php echo BASE_URL; ?>/staff/notifications.php" class="nav-item <?php echo $nav_current_file === 'notifications.php' ? 'active' : ''; ?>">
                ...
                Notifications
                <?php 
                $unread_count = get_unread_notification_count(get_user_id(), 'Staff');
                ?>
                <span id="notif-badge-sidebar" class="notif-badge-pill" style="<?php echo $unread_count > 0 ? '' : 'display:none;'; ?>">
    ...
    <script>
        ...
        function updateNotificationCount() {
            fetch('<?php echo BASE_URL; ?>/staff/api/notification_count.php')
    ...
    <div class="sidebar-footer">
        <a href="<?php echo BASE_URL; ?>/staff/profile.php" class="user-profile" style="text-decoration: none; color: inherit; display: flex; align-items: center; gap: 12px; padding: 8px; border-radius: 6px; transition: background 0.2s;">
